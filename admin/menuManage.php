                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <img src="/Parfume_site/img/pizza-'.$prodId. '.jpg" alt="image for this item" width="150px" height="150px">
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
												<div class="row mx-auto" style="width:112px">
													...
													<form action="partials/_menuManage.php" method="POST">
														...
														<input type="hidden" name="pizzaId" value="'.$prodId. '">
													</form>
												</div>
                                            </td>
                                        </tr>';
...
<?php 
    ...
    while($prodRow = mysqli_fetch_assoc($prodResult)){
        ...
        $price = $prodRow['price'];
        $prodCategorieId = $prodRow['prodCategorieId'];
        $desc = $prodRow['desc'];
?>
	  	...
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/Parfume_site/img/pizza-<?php echo $prodId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="partials/_menuManage.php" method="post">
